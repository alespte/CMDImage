...
public class CMDImage {
    ...
    public static void main(String[] args) throws IOException {     
        String imagePath = " "; //Ruta de la imagen que desean generar
        String generatedBWImagePath = ""; //Ruta donde van a guardar la imagen en blanco y negro
        String resizedBWImagePath = ""; //Ruta donde van a guardar la imagen redimensionada
